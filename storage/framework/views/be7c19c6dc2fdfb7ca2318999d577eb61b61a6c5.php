        ...
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item ">
                    ...
                    <a class="nav-link menu-link <?php echo e(active_class(['products/*'])); ?>" href="<?php echo e(url('/products')); ?>">
                        <i class="ri-file-list-3-line"></i> <span data-key="t-landing"><?php echo app('translator')->get('translation.products'); ?></span>
                    </a>
                </li>
...
<?php /**PATH D:\git\admin-mulia\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>