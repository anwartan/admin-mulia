        ...
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item ">
                    ...
                    <a class="nav-link menu-link {{ active_class(['products/*']) }}" href="{{ url('/products') }}">
                        <i class="ri-file-list-3-line"></i> <span data-key="t-landing">@lang('translation.products')</span>
                    </a>
                </li>
                {{-- <li class="nav-item">
                    <a href="#sidebarEcommerce" class="nav-link " data-bs-toggle="collapse" role="button"
                        aria-expanded="false" aria-controls="sidebarEcommerce">
                        <i class="ri-file-list-3-line"></i>@lang('translation.ecommerce')
                    </a>
